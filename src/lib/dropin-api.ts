...
const clinicsURL =
  "https://data.mmao.ca/ghlLeagues/aGagGPzv1aS4v8hffakm?ver=1773359594561&age=adult&program_type=clinic";
const dropinURL =
  "https://data.mmao.ca/ghlLeagues/aGagGPzv1aS4v8hffakm?age=adult&program_type=drop_in";

async function fetchMomentumAPI(url: string, cacheKey: string): Promise<VolleyballApiResponse> {
...
export function getCachedSchedule(cacheKey: string): VolleyballApiResponse | undefined {
  try {
